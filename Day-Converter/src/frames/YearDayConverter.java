...
public class YearDayConverter extends JFrame {
...
//        menuBar.add(helpMenu);
        ...
        hitoryItem.addActionListener(new myActionListener());
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                years = field1.getText();
                months = field2.getText();
                weeks = field3.getText();
                converter = new ConversionProgram(years,months,weeks);
                days = converter.other_to_day();

                field4.setText(days);
                history = new History_write_read(years + " years " + ", " + months + ", " + weeks + " are converted to " + days + " days at: "); ;
                history.History_WRITE();
            }
        });
        label4 = new JLabel("Days:");
